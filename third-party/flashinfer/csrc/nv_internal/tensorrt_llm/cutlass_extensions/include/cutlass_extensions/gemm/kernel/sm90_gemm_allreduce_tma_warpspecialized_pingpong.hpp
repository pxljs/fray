...
template <class ProblemShape_, class CollectiveMainloop_, class CollectiveEpilogue_,
          class CollectiveAllReduce_, class TileScheduler_>
class GemmARUniversal<
    ProblemShape_, CollectiveMainloop_, CollectiveEpilogue_, CollectiveAllReduce_, TileScheduler_,
 ...
 public:
  ...
  using TileScheduler = typename detail::TileSchedulerSelector<TileScheduler_, ArchTag, TileShape,
  ...
  static Params to_underlying_arguments(Arguments const& args, void* workspace) {
    ...
    return {args.mode,
            ...
            hw_info,
            TileScheduler::to_underlying_arguments(problem_shape_MNKL, TileShape{}, ClusterShape{},
...
// Any Tensor Op MMA Atom in the WGMMA ISA is arch conditional to sm90a.
    ...
    LoadWarpOrderBarrier allreduce_order_barrier(shared_storage.pipelines.allreduce_order,
                                                 params_allreduce_order_barrier);
    ...
    if (warp_group_role == WarpGroupRole::Producer) {
      ...
      constexpr uint32_t AllReduceBarrier0 =
          uint32_t(cutlass::arch::ReservedNamedBarriers::FirstUserBarrier) + 1;
      constexpr uint32_t AllReduceBarrier1 =
          uint32_t(cutlass::arch::ReservedNamedBarriers::FirstUserBarrier) + 2;
      ...
      while (work_tile_info.is_valid()) {
        ...
        collective_mainloop.mma(mainloop_pipeline, mainloop_pipe_consumer_state, accumulators,
                                k_tile_count, warp_group_thread_idx,
        ...
        auto [epi_load_pipe_consumer_state_next, epi_store_pipe_producer_state_next] =
            collective_epilogue.store(
                ...
                accumulators, tiled_mma, warp_group_thread_idx, shared_storage.tensors.epilogue);
        ...
        collective_all_reduce.gather_reduce_broadcast(problem_shape_MNKL, blk_coord,
      ...
      if (tile_count > 0) {
        collective_all_reduce.tile_global_sync(problem_shape_MNKL, prev_blk_coord,
                                               warp_group_thread_idx);
      }
