...
// Here we instantiate some structs to "detag" the tagged operator. It splits it back to the
// original operator + the extra information. If no extra info was tagged, the dequant op per column
// scaling as a default.
