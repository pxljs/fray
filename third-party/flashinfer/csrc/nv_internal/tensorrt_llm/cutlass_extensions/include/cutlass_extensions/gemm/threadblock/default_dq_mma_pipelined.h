...
struct DefaultScaleIteratorsPipelined<MmaShape, Element, Layout, QuantOp, Alignment,
 ...
 public:
  ...
  using SmemIteratorScale = cutlass::transform::threadblock::FineGrainedScaleZeroIterator<
      cutlass::MatrixShape<1, MmaShape::kN>, SmemScaleType, Layout, 0, Alignment>;
};
...
struct DefaultScaleIteratorsPipelined<MmaShape, Element, Layout, QuantOp, Alignment,
 ...
 public:
  ...
  using SmemIteratorScale =
      cutlass::transform::threadblock::PredicatedTileIterator<cutlass::MatrixShape<1, MmaShape::kN>,
                                                              SmemScaleType, Layout, 0,
...
struct DqMma<
    ...
    WarpShape, InstructionShape, 2, Operator_, SharedMemoryClearOption::kNone,
  ...
  using MmaCoreElementB =
      typename platform::conditional<DqAfterLDG, MmaCoreElementA, ElementB>::type;

  // Define the MmaCore components
  using MmaCore = typename cutlass::gemm::threadblock::DefaultMmaCore<
      ThreadblockShape, WarpShape, InstructionShape, MmaCoreElementA, LayoutA, MmaCoreElementB,
      LayoutB, ElementAccumulator, layout::RowMajor, OperatorClass, 2, Operator>;
  ...
  using ScaleIterators =
      DefaultScaleIteratorsPipelined<typename MmaCore::Shape, ElementScale, LayoutScale,
  ...
  using ThreadblockMma = cutlass::gemm::threadblock::DqMmaPipelined<
      ...
      typename MmaCore::SmemIteratorB, IteratorScale, SmemIteratorScale, ElementAccumulator,
      layout::RowMajor, typename MmaCore::MmaPolicy, typename Converters::TransformAfterLDG,
...
struct DqMma<
  ...
  using MmaCore = typename cutlass::gemm::threadblock::DefaultMmaCore<
      ThreadblockShape, WarpShape, InstructionShape, MmaCoreElementA, LayoutA, MmaCoreElementB,
      layout::ColumnMajor, ElementAccumulator, layout::RowMajor, OperatorClass, 2, Operator>;
 ...
 public:
  // Define iterators over tiles from the B operand
  using IteratorB = cutlass::transform::threadblock::PredicatedTileIterator<
      GmemIteratorShape, ElementB, layout::ColumnMajor, 0, GmemThreadMapB, kAlignmentB>;
