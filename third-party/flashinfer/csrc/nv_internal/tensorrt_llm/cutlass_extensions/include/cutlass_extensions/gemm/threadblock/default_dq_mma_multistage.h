...
template <typename MmaShape, typename Element, typename Layout, WeightOnlyQuantOp QuantOp,
          int Alignment, typename Enable = void>
...
struct DefaultScaleIteratorsMultistage<MmaShape, Element, Layout, QuantOp, Alignment,
  ...
  using IteratorScale = cutlass::transform::threadblock::FineGrainedScaleZeroIterator<
      cutlass::MatrixShape<1, MmaShape::kN>, Element, Layout, 0, Alignment>;
...
struct DefaultScaleIteratorsMultistage<MmaShape, Element, Layout, QuantOp, Alignment,
 ...
 private:
  using IteratorScaleThreadMap =
      transform::PitchLinearStripminedThreadMap<layout::PitchLinearShape<MmaShape::kN, 1>,
 ...
 public:
  ...
  using IteratorScale = cutlass::transform::threadblock::PredicatedTileIterator<
      cutlass::MatrixShape<1, MmaShape::kN>, Element, Layout, 0, IteratorScaleThreadMap, Alignment>;
...
struct DqMma<
    ElementA, LayoutA, kAlignmentA, ElementB, LayoutB, kAlignmentB, ElementScale, LayoutScale,
    kAlignmentScale, ElementAccumulator, layout::RowMajor, OperatorClass, ArchTag, ThreadblockShape,
    WarpShape, InstructionShape, kStages, Operator_, SharedMemoryClear,
  ...
  // Mma core does not depend on stages, so pass in at least 3 here to mma multistage pieces are
  // created
  using MmaCore = typename cutlass::gemm::threadblock::DefaultMmaCore<
      ThreadblockShape, WarpShape, InstructionShape, ElementA, LayoutA, ElementB, LayoutB,
      ElementAccumulator, layout::RowMajor, OperatorClass, std::max(kStages, 3), Operator, false,
      CacheOpA, CacheOpB>;
  ...
  using IteratorA = cutlass::transform::threadblock::PredicatedTileAccessIterator<
      cutlass::MatrixShape<ThreadblockShape::kM, ThreadblockShape::kK>, ElementA, LayoutA, 1,
      ThreadMapA, AccessTypeA>;

  // Define iterators over tiles from the B operand
  using ThreadMapB = typename MmaCore::IteratorThreadMapB;
  using AccessTypeB = cutlass::Array<ElementB, kAlignmentB>;
  using IteratorB = cutlass::transform::threadblock::PredicatedTileAccessIterator<
      cutlass::MatrixShape<ThreadblockShape::kK, ThreadblockShape::kN>, ElementB, LayoutB, 0,
      ThreadMapB, AccessTypeB>;

  using ScaleIterators =
      DefaultScaleIteratorsMultistage<typename MmaCore::Shape, ElementScale, LayoutScale,
  ...
  using Converter = FastInterleavedAndBiasedNumericArrayConverter<
      ElementScale, ElementB, MmaCore::MmaPolicy::Operator::FragmentB::kElements>;
  ...
  using ThreadblockMma = cutlass::gemm::threadblock::DqMmaMultistage<
      ...
      IteratorB, typename MmaCore::SmemIteratorB, MmaCore::kCacheOpB, IteratorScale,
      SmemIteratorScale, ElementAccumulator, layout::RowMajor, typename MmaCore::MmaPolicy, kStages,
      Converter, OperatorInfo::QuantOp, SharedMemoryClear>;
};
...
struct DqMma<
  ...
  using MmaCore = typename cutlass::gemm::threadblock::DefaultMmaCore<
      ...
      layout::ColumnMajor, ElementAccumulator, layout::RowMajor, OperatorClass,
 ...
 public:
  ...
  using AccessTypeB = cutlass::Array<ElementB, kAlignmentB>;
  using IteratorB = cutlass::transform::threadblock::PredicatedTileAccessIterator<
      GmemIteratorShape, ElementB, layout::ColumnMajor, 0, GmemThreadMapB, AccessTypeB>;
