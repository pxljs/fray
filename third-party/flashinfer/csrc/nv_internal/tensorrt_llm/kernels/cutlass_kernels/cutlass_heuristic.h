...
std::vector<tensorrt_llm::cutlass_extensions::CutlassGemmConfig> get_candidate_configs(
    ...
    tensorrt_llm::cutlass_extensions::CutlassGemmConfig::CandidateConfigTypeParam const);
...
tensorrt_llm::cutlass_extensions::CutlassGemmConfig estimate_best_config_from_occupancies(
    ...
    std::vector<int> const& occupancies, int64_t const m, int64_t const n, int64_t const k,
    int64_t const num_experts, int const split_k_limit, size_t const workspace_bytes,
