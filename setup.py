...
class PostDevelopCommand(develop):
    ...
    def make_jit_include_symlinks():
        ...
        for d in third_party_include_dirs:
            ...
            dst_dir = os.path.join(current_dir, "fray/include", dirname)
    ...
    def make_jit_include_symlinks_specific():
        ...
        dst_dir = os.path.join(current_dir, "fray/include", "tk")
        assert os.path.exists(src_dir)
        if os.path.exists(dst_dir):
            assert os.path.islink(dst_dir)
            os.unlink(dst_dir)
...
class CustomBuildPy(build_py):
    ...
    def prepare_includes(self):
        ...
        build_include_dir = os.path.join(self.build_lib, "fray/include")
