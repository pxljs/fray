...
def get_nvcc_compiler() -> Tuple[str, str]:
    ...
    if IS_WINDOWS:
        ...
        for cuda_version in ['v12.3', 'v12.4', 'v12.5', 'v12.6', 'v12.7', 'v12.8', 'v13.2']:
...
def build(name: str, arg_defs: tuple, code: str) -> Runtime:
    ...
    if os.getenv('FRAY_JIT_DEBUG', None) or os.getenv('FRAYJIT_PRINT_NVCC_COMMAND', False):
